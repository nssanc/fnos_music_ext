(() => {
  ...
  async function openSourceMenu() {
    ...
    try {
      ...
      const labels={qqmusic:'QQ 音乐',netease:'网易云音乐',musicdl:'酷我 / 咪咕',lx:'洛雪音乐源'};
