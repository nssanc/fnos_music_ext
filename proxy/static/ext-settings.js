(() => {
  ...
  @media(max-width:720px){
    html,body,#root{width:100%;max-width:100%;overflow-x:hidden}.music-player-root{min-width:0!important}.semi-table-container,.semi-table-body{max-width:100vw;overflow-x:auto!important;-webkit-overflow-scrolling:touch}.semi-modal,.semi-modal-content{max-width:calc(100vw - 24px)!important}.semi-modal{margin:12px!important}.semi-dropdown{max-width:calc(100vw - 16px)!important}
    ...
    #fmx-open{right:max(10px,env(safe-area-inset-right));bottom:calc(94px + env(safe-area-inset-bottom));width:42px;height:42px;padding:0;border-radius:50%;font-size:0}#fmx-open:after{content:'音源';font-size:11px}
    #fmx-player-source{right:max(10px,env(safe-area-inset-right));bottom:calc(142px + env(safe-area-inset-bottom));max-width:calc(100vw - 20px);min-height:38px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#fmx-source-menu{left:10px;right:10px;bottom:calc(92px + env(safe-area-inset-bottom));min-width:0;border-radius:14px;padding:8px}#fmx-source-menu button{min-height:46px;font-size:15px}
  }
  @media(max-width:720px) and (orientation:landscape){#fmx-open{bottom:calc(70px + env(safe-area-inset-bottom))}#fmx-player-source{bottom:calc(70px + env(safe-area-inset-bottom));right:62px}.fmx-panel{max-height:94dvh}}
  `;
